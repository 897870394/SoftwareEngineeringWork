...
Page({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '简易计算', 'src': '/image/jisuanqi.png', 'name':'jisuanqi' },
        { 'index': 1, 'menu': '还款计算', 'src': '/image/fangdai.png', 'name': 'fangdai' },
        { 'index': 2, 'menu': '今日运势', 'src': '/image/aixin.png', 'name': 'aixin' },
      ]
    }
    // 绘制转盘
